...
def main(args: Namespace) -> int:
    ...
    if platform == "xavier":
        config_name = "certificate_TC_A.xavier.yaml"
    else:
        config_name = "certificate_TC_A.yaml"
    ...
    def _event_callback(
        ...
        fs_tc_events = {
            ...
            "predictions": {
                "drowsiness": d_events["drowsiness"] or p_events["drowsiness"],
                "distraction": d_events["distraction"] or p_events["distraction"],
                "faint": d_events["faint"] or p_events["faint"],
                "negative_wheelgrab": d_events["negative_wheelgrab"],
            },
            "performance_metrics": {
    ...
    logger.info("===================================")
    logger.info("      Beginning Test Case A        ")
