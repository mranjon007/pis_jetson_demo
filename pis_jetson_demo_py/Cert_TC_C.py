...
def main(args: Namespace) -> int:
    ...
    if platform == "xavier":
        config_name = "certificate_TC_C.xavier.yaml"
    else:
        config_name = "certificate_TC_C.yaml"
    ...
    def _event_callback(
        ...
        fs_tc_events = {
            "metadata": {
                ...
                "id": G_TEST_ITERATION,
                "type": "onboard",  # onboard, status, action
            },
            "predictions": {
                "onboarding": {
                    "driver": d_events["seat_existence"],
                    "passenger": p_events["seat_existence"],
                }
            },
            "performance_metrics": {
    ...
    logger.info("===================================")
    logger.info("      Beginning Test Case C        ")
