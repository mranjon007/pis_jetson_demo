...
class SeatExistenceEvent(BaseEvent):
    def __init__(
        self,
        ptype: PassengerType,
...
class SeatExistenceEventProcessor(BaseEventCallbackProcessor):
    LOG_HEADER: str = "[SeatExistence] "
    ...
    def __init__(
        ...
        """Processes seat existence event.
        ...
        """
        super(SeatExistenceEventProcessor, self).__init__()
    ...
    def update(self, all_detections: List[DetectionItem]):
        ...
        if not persons:
            ...
            if self.detect_criteria(persons[0]):
                logger.debug(
    ...
    def detect_criteria(
        ...
        """
        # Send event when person exists in the seat
